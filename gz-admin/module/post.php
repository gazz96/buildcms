...
function post_data(){
	...
	<div class="module-header">
		...
		<h3 class="module-title">Data Post
			<a href="?module=add_post" class="btn-add">Tambah Data</a>
		</h3> 
							...
							<div class="widget-body">
								<div class="form-group">
									...
									<select name="id_kategori" id="" class="form-control">
										<?php 
											$query_str = "SELECT * FROM kategori WHERE aktif='Y' ORDER BY nama_kategori ASC";
								...
								<div class="form-group">
									...
									<select name="id_kategori" id="" class="form-control">
										<?php 
											...
											while($data = $query->fetch_array()){
										?>
											<option value="<?php echo $data['id_kategori']; ?>"  <?php if($id_kategori == $data['id_kategori']){ echo "selected"; } ?>><?php echo $data['nama_kategori']; ?></option>
										<?php } ?>
